...
local function EEHTT_fake_script() -- Execute.LocalScript 
...
coroutine.wrap(EEHTT_fake_script)()
local function XLRSB_fake_script() -- Execute_2.LocalScript 
...
coroutine.wrap(XLRSB_fake_script)()
local function VCRJ_fake_script() -- Execute_3.LocalScript 
...
coroutine.wrap(VCRJ_fake_script)()
local function PZPITMX_fake_script() -- KillHub.LocalScript 
...
coroutine.wrap(PZPITMX_fake_script)()
